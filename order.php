        ...
        <div class="all-forms">
          ...
          <form action="process_upi_transaction.php" method="post" class="payment-form">
            ...
            <div class="text-center">
                <button type="submit" class="pay-now cursor-default sm:cursor-pointer capitalize text-white bg-black rounded-lg px-6 py-3 w-full sm:w-[60%] mt-3">pay now</button>
            </div>
          </form>
